...
public class PomeriumContainerRunningAsNonRootShould {
    private static final Logger logger = LoggerFactory.getLogger(PomeriumContainerRunningAsNonRootShould.class);
